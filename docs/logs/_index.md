...
- [2026-07-17 - Weekly digest](2026-07-17-weekly.md): canonical split and clip-alignment audit linked into current planning.
- [2026-07-24 - Weekly digest](2026-07-24-weekly.md): full large-v3 LoRA run completed, adapter published, current docs normalized around A/B and robustness follow-up.
