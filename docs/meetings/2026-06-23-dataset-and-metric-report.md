...
Πηγές: `eval/` harness, `data/reports/coverage.json`, `docs/specs/dataset-split-and-publish-plan.md`,
...
| | τιμή |
|---|---|
| **Micro HIR** | **28.1%** (Wilson 95% CI 28.0–28.3%) |
...
(+ μακριά ουρά πόλεων με 1 meeting). Πλήρης πίνακας: `data/reports/coverage.json`
